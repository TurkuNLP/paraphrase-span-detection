The original code for SQuAD is from: https://github.com/huggingface/transformers/tree/master/examples/pytorch/question-answering

The code for this project was fetched from the above mentioned repository on 7th of June 2021.

To run the code in CSC Mahti:

Run the code in a Singularity container. No venv needed, instead use option: --user when pip installing.
...
To run HuggingFace example code install transformers from the source:
...
```bash
sbatch train_qa.bash
```

Original HuggingFace README.md follows:
